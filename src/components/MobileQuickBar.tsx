...
export const MobileQuickBar: React.FC<MobileQuickBarProps> = ({ navigate }) => {
  ...
  return (
    <div 
      ...
      className={`fixed bottom-0 left-0 right-0 z-50 lg:hidden px-3 py-2.5 backdrop-blur-xl border-t shadow-2xl transition-colors ${
        isDark 
    ...
    >
      <div className="max-w-md mx-auto grid grid-cols-4 gap-2 items-center">
        ...
        <a
          ...
          className="col-span-2 py-2.5 px-3 rounded-xl bg-gradient-to-r from-[#25D366] to-[#128C7E] hover:from-[#20bd5a] hover:to-[#0f776a] text-black font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-1.5 shadow-md active:scale-95 transition-transform"
        >
        ...
        <a
          ...
          className={`py-2.5 px-2 rounded-xl border font-bold text-[11px] uppercase tracking-wider flex flex-col items-center justify-center gap-0.5 shadow-sm active:scale-95 transition-transform ${
            isDark 
        ...
        <button
          ...
          className={`py-2.5 px-2 rounded-xl border font-bold text-[11px] uppercase tracking-wider flex flex-col items-center justify-center gap-0.5 shadow-sm active:scale-95 transition-transform ${
            isDark 
              ? 'bg-[#151c2c] border-[#25354e] text-[#c5a880] hover:bg-[#1b253b]' 
              : 'bg-[#faf6f0] border-[#c5a880] text-[#855d21] hover:bg-[#f3ece0]'
          }`}
        >
